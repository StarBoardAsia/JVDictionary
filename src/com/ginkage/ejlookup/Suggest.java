...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static ArrayList<String> getLookupResults(Context context, String request, AsyncTask<String, Integer, ArrayList<String>> task)
	{
		...
		int maxsug = Integer.parseInt(JVLookupActivity.getString(context.getString(R.string.setting_max_suggest), "10"));
		boolean romanize = JVLookupActivity.getBoolean(context.getString(R.string.setting_suggest_romaji), true);

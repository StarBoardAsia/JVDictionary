...
public class JVLookupActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!expansionFilesDelivered()) {
			startActivity(new Intent(JVLookupActivity.this, DictionaryDownloaderActivity.class));
			finish();
			return;
		}
		...
		search.setOnLongClickListener(new OnLongClickListener() {
			public boolean onLongClick(View v) {
				...
				if (paste == null || paste.length() == 0)
					Toast.makeText(JVLookupActivity.this, getString(R.string.text_clipboard_empty), Toast.LENGTH_LONG).show();
				else {
					query.setText(paste);
...
*/					break;
	...
	void Mount()
	{
		...
		if (storageManager.isObbMounted(expFile) || bugKitKat)
			...
			isMount = storageManager.mountObb(expFile, null, mStateListener);
		}
	}
	...
	private class GetSuggestTask extends AsyncTask<String, Integer, ArrayList<String>> {
		...
		protected ArrayList<String> doInBackground(String... args) {
			if (args != null) {
				...
				return Suggest.getLookupResults(JVLookupActivity.this, request, this);
			} else {
				return null;
			}
		}
		...
		protected void onPostExecute(ArrayList<String> lines) {
			if (lines != null) {
				ArrayAdapter<String> suggest = new ArrayAdapter<String>(JVLookupActivity.this,
	...
	private class GetLookupResultsTask extends AsyncTask<String, Integer, ArrayList<ResultLine>> {
		private JVLookupActivity curContext;
		...
		protected ArrayList<ResultLine> doInBackground(String... args)
		{
			...
			return DictionaryTraverse.getLookupResults(JVLookupActivity.this, request);
		}
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item)
	{
		if (featureId == Window.FEATURE_OPTIONS_PANEL) {
			if (item.getItemId() == R.id.itemSettings) {
				Intent i = new Intent(JVLookupActivity.this, Settings.class);
				startActivity(i);
			}
